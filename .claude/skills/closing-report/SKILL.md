---
name: closing-report
description: 產生當日台股收盤報告(精簡版):新聞掃描+大盤+持股/Top5 價量與三大法人+否證檢核+明日觀察,填入模板 F、寫成 Obsidian 筆記、更新 Portfolio/索引後 commit。當使用者輸入 /closing-report、/收盤報告,或說「寫收盤報告、今天收盤、收盤簡報」時使用。
---
...
## 步驟
1. **確認資料日**:先 `list_available_dates` 或 `get_market_history` 確認最新交易日;報告寫「該收盤日」(非今天日曆日)。若使用者未指定,用最新交易日。
